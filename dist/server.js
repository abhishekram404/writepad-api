...
const generatePadCode = (0, nanoid_1.customAlphabet)("abcdefghijklmnopqrstuvwxyz", 6);
...
io.on("connection", (socket) => {
    ...
    socket.on("join pad", (joinCode) => {
        ...
        io.to(code).emit("new user", (_a = io.sockets.adapter.rooms.get(code)) === null || _a === void 0 ? void 0 : _a.size);
        setInterval(() => {
            var _a;
            io.to(code).emit("new user", (_a = io.sockets.adapter.rooms.get(code)) === null || _a === void 0 ? void 0 : _a.size);
        }, 5000);
    ...
    socket.on("leave pad", (padCode) => {
        ...
        io.to(padCode).emit("new user", (_a = io.sockets.adapter.rooms.get(padCode)) === null || _a === void 0 ? void 0 : _a.size);
    });
